...
void _updateContextUtilityFile(String contextUtilityFilepath) {
  var checklistBoundary =
      '''ChecklistSingleton().setBoundary(boundary: selectedBoundary);''';
...
void _updateEntityMapperFile(String entityMapperFilePath) {
  ...
  var importStatement = "import 'package:checklist/checklist.dart';";
  var newCases = '''
      case "service":
...
// Check if the remote repository of checklist already exists in the file
    for (var remoteRepositoryOfChecklist in remoteRepositoriesOfChecklist) {
...
void _createLocalizationDelegatesFile(String localizationDelegatesFilePath) {
  ...
  var delegate = '''checklist_localization.ChecklistLocalization.getDelegate(
