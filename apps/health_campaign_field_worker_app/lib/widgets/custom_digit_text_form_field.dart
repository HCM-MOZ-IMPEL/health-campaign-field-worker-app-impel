...
class CustomDigitTextFormField extends StatelessWidget {
  final bool readOnly;
  ...
  final bool Function(dynamic)?
      colorCondition; // Added parameter for color condition

  const CustomDigitTextFormField({
    super.key,
    required this.label,
    ...
    required this.colorCondition, // Required parameter for color condition
  });
            ...
            builder: (context, formControl, child) {
              return ReactiveTextField(
                  ...
                  style: TextStyle(
                    ...
                    color: colorCondition!(formControl.value)
                        ? Colors.red
                        : Colors.green,
                  ),
