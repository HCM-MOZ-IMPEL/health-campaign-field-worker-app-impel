...
class StatusFilterBednet extends LocalizedStatefulWidget {
  final List<String>? selectedFilters;
  final bool isCloseIcon;
  final Icon? titleIcon;
  final String? titleText;

  const StatusFilterBednet({
    super.key,
  ...
  @override
  State<StatusFilterBednet> createState() => StatusFilterBednetState();
}

class StatusFilterBednetState extends LocalizedState<StatusFilterBednet> {
                  ...
                  child: SelectionBox<Status>(
                    ...
                    valueMapper: (value) {
                      return localizations.translate(
                          '${value.toValue().toString()}_${Constants.bednetLabel}');
                    },
                  ),
                ),
                const SizedBox(
