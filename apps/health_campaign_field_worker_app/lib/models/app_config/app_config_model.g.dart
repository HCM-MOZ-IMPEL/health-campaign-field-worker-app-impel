...
_$RefusalReasonsCommentOptionsImpl _$$RefusalReasonsCommentOptionsImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$RefusalReasonsCommentOptionsImplToJson(
        _$RefusalReasonsCommentOptionsImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
      'code': instance.code,
    };
