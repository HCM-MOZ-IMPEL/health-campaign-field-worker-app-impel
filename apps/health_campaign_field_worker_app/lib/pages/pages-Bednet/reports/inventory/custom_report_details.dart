...
// @RoutePage()
// class CustomInventoryReportDetailsBednetPage extends LocalizedStatefulWidget {
//   final InventoryReportType reportType;

//   const CustomInventoryReportDetailsBednetPage({
//     super.key,
...
//   @override
//   State<CustomInventoryReportDetailsBednetPage> createState() =>
//       CustomInventoryReportDetailsBednetPageState();
// }

// class CustomInventoryReportDetailsBednetPageState
//     extends LocalizedState<CustomInventoryReportDetailsBednetPage> {
...
//   void loadReport(
//       InventoryReportBloc inventoryReportBloc, String productVariantId) {
//     final event = widget.reportType == InventoryReportType.reconciliation
//         ? InventoryReportLoadStockReconciliationDataEvent(
...
//                   projectId: InventorySingleton().projectId,
//                   child: BlocListener<InventoryProductVariantBloc,
//                       InventoryProductVariantState>(
//                     listener: (context, productVariantStateListener) {
//                       productVariantStateListener.maybeWhen(
//                           orElse: () {},
//                           fetched: (variants) {
//                             if (!isWareHouseManager) {
//                               loadReport(context.read<InventoryReportBloc>(),
//                                   variants.first.id);
//                             }
//                           });
//                     },
//                     child: BlocBuilder<InventoryProductVariantBloc,
//                         InventoryProductVariantState>(
...
//                                                                                 widget.reportType == InventoryReportType.returned ||
...
//                                                                         key:
//                                                                             commentsKey,
//                                                                         value: (model.commentsOnReconciliation ??
//                                                                             ''),
//                                                                       ),
//                                                                     ],
//                                                                   ),
