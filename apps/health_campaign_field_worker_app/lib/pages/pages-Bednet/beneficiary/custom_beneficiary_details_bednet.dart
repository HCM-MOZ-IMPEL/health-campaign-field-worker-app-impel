...
@RoutePage()
class CustomBeneficiaryDetailsBednetPage extends LocalizedStatefulWidget {
  const CustomBeneficiaryDetailsBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomBeneficiaryDetailsBednetPage> createState() =>
      CustomBeneficiaryDetailsBednetPageState();
}

class CustomBeneficiaryDetailsBednetPageState
    extends LocalizedState<CustomBeneficiaryDetailsBednetPage> {
  @override
  void initState() {
