...
@RoutePage()
class CustomDeliverySummaryBednetPage extends LocalizedStatefulWidget {
  const CustomDeliverySummaryBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomDeliverySummaryBednetPage> createState() =>
      DeliverySummaryPageState();
}

class DeliverySummaryPageState
    extends LocalizedState<CustomDeliverySummaryBednetPage> {
        ...
        body: BlocBuilder<HouseholdOverviewBloc, HouseholdOverviewState>(
          ...
          return BlocConsumer<DeliverInterventionBloc,
            ...
            builder: (context, deliverState) {
              final dob = getAge(state, localizations);
                  ...
                  header: Column(children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: kPadding, left: kPadding),
                      child: Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          localizations.translate(
                            i18_local.common.coreCommonSummaryDetailsSMC,
                          ),
                          style: DigitTheme
                              ...
                              : () async {
                                  final submit = await DigitDialog.show<bool>(
                                    ...
                                    options: DigitDialogOptions(
                                      ...
                                      contentText: localizations.translate(i18
                          ...
                          DigitCard(
                            child: LabelValueList(
                                ...
                                items: [
                                  ...
                                  LabelValuePair(
                                      label: localizations.translate(i18_local
                                          .individualDetails.ageLabelText),
                                      value: dob.toString(),
                                      isInline: true),
                                ]),
                          ),
...
String? getAge(HouseholdOverviewState state,
    RegistrationDeliveryLocalization localizations) {
  var dob = state.selectedIndividual?.dateOfBirth;
