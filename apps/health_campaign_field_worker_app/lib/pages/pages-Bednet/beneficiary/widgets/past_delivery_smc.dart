      ...
      children: [
          ...
          element: {
            localizations.translate(
              i18.beneficiaryDetails.beneficiaryAge,
                ...
                ? '${utilsLocal.getAgeConditionString('$condition', context)} ${localizations.translate(context.projectTypeCode == ProjectTypes.smc.toValue() ? i18.individualDetails.monthsHintText : i18.individualDetails.yearsHintText)}'
                : null,
          },
        ),
        const Divider(
        ...
        productVariants != null
            ? DigitTable(
                ...
                height: ((productVariants ?? []).length + 1) * cellHeight,
              )
