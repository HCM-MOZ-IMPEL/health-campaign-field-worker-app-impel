...
@RoutePage()
class DoseAdministeredVerificationBednetPage extends LocalizedStatefulWidget {
  const DoseAdministeredVerificationBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<DoseAdministeredVerificationBednetPage> createState() =>
      _DoseAdministeredVerificationBednetPageState();
}

class _DoseAdministeredVerificationBednetPageState
    extends LocalizedState<DoseAdministeredVerificationBednetPage> {
