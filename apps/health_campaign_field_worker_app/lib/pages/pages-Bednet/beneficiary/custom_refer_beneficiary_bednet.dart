...
@RoutePage()
class CustomReferBeneficiaryBednetPage extends LocalizedStatefulWidget {
  ...
  const CustomReferBeneficiaryBednetPage({
    super.key,
  ...
  @override
  State<CustomReferBeneficiaryBednetPage> createState() =>
      CustomReferBeneficiaryBednetPageState();
}

class CustomReferBeneficiaryBednetPageState
    extends LocalizedState<CustomReferBeneficiaryBednetPage> {
