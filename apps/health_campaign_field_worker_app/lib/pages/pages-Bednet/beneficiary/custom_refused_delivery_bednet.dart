...
@RoutePage()
class CustomRefusedDeliveryBednetPage extends LocalizedStatefulWidget {
  const CustomRefusedDeliveryBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomRefusedDeliveryBednetPage> createState() =>
      CustomRefusedDeliveryBednetPageState();
}

class CustomRefusedDeliveryBednetPageState
    extends LocalizedState<CustomRefusedDeliveryBednetPage> {
