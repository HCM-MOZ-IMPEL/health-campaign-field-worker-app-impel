...
@RoutePage()
class CustomBeneficiaryChecklistBednetPage extends LocalizedStatefulWidget {
  final String? beneficiaryClientRefId;
  const CustomBeneficiaryChecklistBednetPage({
    super.key,
  ...
  @override
  State<CustomBeneficiaryChecklistBednetPage> createState() =>
      _CustomBeneficiaryChecklistBednetPageState();
}

class _CustomBeneficiaryChecklistBednetPageState
    extends LocalizedState<CustomBeneficiaryChecklistBednetPage> {
