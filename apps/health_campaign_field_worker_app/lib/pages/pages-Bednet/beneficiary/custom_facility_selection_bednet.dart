...
@RoutePage()
class CustomInventoryFacilitySelectionBednetPage
    extends LocalizedStatefulWidget {
  final List<FacilityModel> facilities;

  const CustomInventoryFacilitySelectionBednetPage({
    super.key,
  ...
  @override
  State<CustomInventoryFacilitySelectionBednetPage> createState() =>
      CustomInventoryFacilitySelectionBednetPageState();
}

class CustomInventoryFacilitySelectionBednetPageState
    extends LocalizedState<CustomInventoryFacilitySelectionBednetPage> {
