...
class CustomStockReconciliationBednetPage extends LocalizedStatefulWidget {
  const CustomStockReconciliationBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomStockReconciliationBednetPage> createState() =>
      _CustomStockReconciliationBednetPageState();
}

class _CustomStockReconciliationBednetPageState
    extends LocalizedState<CustomStockReconciliationBednetPage> {
                                          ...
                                          builder: (ctx, form, child) =>
                                            ...
                                            onPressed: !form.valid ||
                                                ...
                                                : () async {
                                                    ...
                                                    final facilityId = InventorySingleton()
                                                                .isDistributor! &&
                                                            !InventorySingleton()
                                                                .isWareHouseMgr!
                                                        ? FacilityModel(
