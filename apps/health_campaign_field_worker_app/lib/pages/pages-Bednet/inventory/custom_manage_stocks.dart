...
@RoutePage()
class CustomManageStocksBednetPage extends LocalizedStatefulWidget {
  const CustomManageStocksBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomManageStocksBednetPage> createState() =>
      _CustomManageStocksBednetPageState();
}

class _CustomManageStocksBednetPageState
    extends LocalizedState<CustomManageStocksBednetPage> {
  @override
  initState() {
    super.initState();
  }
