...
class CustomHouseholdOverviewBednetPage extends LocalizedStatefulWidget {
  const CustomHouseholdOverviewBednetPage({super.key, super.appLocalizations});

  @override
  State<CustomHouseholdOverviewBednetPage> createState() =>
      _CustomHouseholdOverviewBednetPageState();
}
