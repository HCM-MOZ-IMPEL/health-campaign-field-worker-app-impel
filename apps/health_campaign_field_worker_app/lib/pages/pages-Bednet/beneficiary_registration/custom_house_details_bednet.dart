...
@RoutePage()
class CustomHouseDetailsBednetPage extends LocalizedStatefulWidget {
  const CustomHouseDetailsBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomHouseDetailsBednetPage> createState() =>
      CustomHouseDetailsBednetPageState();
}

class CustomHouseDetailsBednetPageState
    extends LocalizedState<CustomHouseDetailsBednetPage> {
