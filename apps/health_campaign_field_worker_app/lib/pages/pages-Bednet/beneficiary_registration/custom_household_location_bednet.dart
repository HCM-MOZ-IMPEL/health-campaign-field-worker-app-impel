...
@RoutePage()
class CustomHouseholdLocationBednetPage extends LocalizedStatefulWidget {
  const CustomHouseholdLocationBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomHouseholdLocationBednetPage> createState() =>
      _CustomHouseholdLocationBednetPageState();
}

class _CustomHouseholdLocationBednetPageState
    extends LocalizedState<CustomHouseholdLocationBednetPage> {
