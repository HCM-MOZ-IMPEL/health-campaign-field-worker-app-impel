...
@RoutePage()
class CustomMarkAttendanceBednetPage extends LocalizedStatefulWidget {
  ...
  const CustomMarkAttendanceBednetPage({
  ...
  @override
  State<CustomMarkAttendanceBednetPage> createState() =>
      _CustomMarkAttendancePageState();
}

class _CustomMarkAttendancePageState
    extends State<CustomMarkAttendanceBednetPage> {
