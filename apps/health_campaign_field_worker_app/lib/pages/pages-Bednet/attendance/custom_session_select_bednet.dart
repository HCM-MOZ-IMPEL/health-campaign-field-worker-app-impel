...
@RoutePage()
class CustomAttendanceDateSessionSelectionBednetPage
    extends LocalizedStatefulWidget {
  final List<AttendanceRegisterModel> registers;
  final String registerID;

  const CustomAttendanceDateSessionSelectionBednetPage({
  ...
  @override
  State<CustomAttendanceDateSessionSelectionBednetPage> createState() =>
      _CustomAttendanceDateSessionSelectionPageState();
}

class _CustomAttendanceDateSessionSelectionPageState
    extends State<CustomAttendanceDateSessionSelectionBednetPage> {
