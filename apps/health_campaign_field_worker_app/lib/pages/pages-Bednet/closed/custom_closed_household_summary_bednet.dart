...
@RoutePage()
class CustomClosedHouseholdSummaryBednetPage extends LocalizedStatefulWidget {
  final reason;
  const CustomClosedHouseholdSummaryBednetPage({
  ...
  @override
  State<CustomClosedHouseholdSummaryBednetPage> createState() =>
      CustomClosedHouseholdSummaryPageState();
}

class CustomClosedHouseholdSummaryPageState
    extends LocalizedState<CustomClosedHouseholdSummaryBednetPage> {
