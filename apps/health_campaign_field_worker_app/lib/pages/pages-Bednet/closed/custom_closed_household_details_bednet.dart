...
@RoutePage()
class CustomClosedHouseholdDetailsBednetPage extends LocalizedStatefulWidget {
  const CustomClosedHouseholdDetailsBednetPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomClosedHouseholdDetailsBednetPage> createState() =>
      CustomClosedHouseholdDetailsPageState();
}

class CustomClosedHouseholdDetailsPageState
    extends LocalizedState<CustomClosedHouseholdDetailsBednetPage> {
