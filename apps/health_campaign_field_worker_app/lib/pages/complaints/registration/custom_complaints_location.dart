...
@RoutePage()
class CustomComplaintsLocationPage extends LocalizedStatefulWidget {
  const CustomComplaintsLocationPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomComplaintsLocationPage> createState() =>
      _ComplaintsLocationPageState();
}

class _ComplaintsLocationPageState
    extends LocalizedState<CustomComplaintsLocationPage> {
