...
@RoutePage()
class CustomComplaintsInboxFilterPage extends LocalizedStatefulWidget {
  const CustomComplaintsInboxFilterPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomComplaintsInboxFilterPage> createState() =>
      _ComplaintsInboxFilterPageState();
}

class _ComplaintsInboxFilterPageState
    extends LocalizedState<CustomComplaintsInboxFilterPage> {
