...
class CustomComplaintsInboxPage extends LocalizedStatefulWidget {
  ...
  @override
  State<CustomComplaintsInboxPage> createState() => _ComplaintsInboxPageState();
}

class _ComplaintsInboxPageState
                        ...
                        child: Row(
                          ...
                          children: [
                            TextButton(
                              ...
                              onPressed: () {
                                router.push(CustomComplaintsInboxSearchRoute());
                              },
                              child: Row(
                                children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                router.push(CustomComplaintsInboxFilterRoute());
                              },
                              child: Row(
                                children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                router.push(CustomComplaintsInboxSortRoute());
                              },
                              child: Row(
                                children: [
              ...
              children: [
                Expanded(
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      context.router.push(CustomComplaintsDetailsViewRoute(
                        complaint: item,
                      ));
                    },
