...
@RoutePage()
class CustomComplaintsInboxSortPage extends LocalizedStatefulWidget {
  const CustomComplaintsInboxSortPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomComplaintsInboxSortPage> createState() =>
      _ComplaintsInboxSortPageState();
}

class _ComplaintsInboxSortPageState
    extends LocalizedState<CustomComplaintsInboxSortPage> {
