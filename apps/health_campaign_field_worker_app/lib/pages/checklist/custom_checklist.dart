...
@RoutePage()
class CustomChecklistPage extends LocalizedStatefulWidget {
  const CustomChecklistPage({
    Key? key,
    super.appLocalizations,
  }) : super(key: key);

  @override
  State<CustomChecklistPage> createState() => _ChecklistPageState();
}

class _ChecklistPageState extends LocalizedState<CustomChecklistPage> {
  @override
