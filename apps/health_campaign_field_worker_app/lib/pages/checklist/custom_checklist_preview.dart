...
@RoutePage()
class CustomChecklistPreviewPage extends LocalizedStatefulWidget {
  const CustomChecklistPreviewPage({
    Key? key,
    super.appLocalizations,
  }) : super(key: key);

  @override
  State<CustomChecklistPreviewPage> createState() =>
      _ChecklistPreviewPageState();
}

class _ChecklistPreviewPageState
    extends LocalizedState<CustomChecklistPreviewPage> {
  @override
