...
@RoutePage()
class CustomChecklistViewPage extends LocalizedStatefulWidget {
  final String? referralClientRefId;
  const CustomChecklistViewPage({
    Key? key,
  ...
  @override
  State<CustomChecklistViewPage> createState() => _ChecklistViewPageState();
}

class _ChecklistViewPageState extends LocalizedState<CustomChecklistViewPage> {
                    ...
                    listener: (context, state) async {
                      if (state.accuracy != null && triggerLocalization) {
                        ...
                        if (shouldSubmit ?? false) {
                          router.navigate(CustomChecklistRoute());
