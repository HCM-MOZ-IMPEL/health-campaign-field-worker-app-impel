...
class CustomBeneficiaryChecklistPage extends LocalizedStatefulWidget {
  ...
  const CustomBeneficiaryChecklistPage({
    super.key,
  ...
  @override
  State<CustomBeneficiaryChecklistPage> createState() =>
      _CustomBeneficiaryChecklistPageState();
}

class _CustomBeneficiaryChecklistPageState
    extends LocalizedState<CustomBeneficiaryChecklistPage> {
