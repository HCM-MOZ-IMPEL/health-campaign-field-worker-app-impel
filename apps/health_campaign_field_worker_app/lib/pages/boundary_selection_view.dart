...
@RoutePage()
class BoundarySelectionViewPage extends LocalizedStatefulWidget {
  const BoundarySelectionViewPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<BoundarySelectionViewPage> createState() =>
      BoundarySelectionViewPageState();
}

class BoundarySelectionViewPageState
    extends LocalizedState<BoundarySelectionViewPage> {
