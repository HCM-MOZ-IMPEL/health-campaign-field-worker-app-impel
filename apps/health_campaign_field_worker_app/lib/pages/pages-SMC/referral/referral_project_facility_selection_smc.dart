...
//   @override
//   State<ReferralReconProjectFacilitySelectionSMCPage> createState() =>
//       _ReferralReconProjectFacilitySelectionPageState();
// }

// class _ReferralReconProjectFacilitySelectionPageState
//     extends LocalizedState<ReferralReconProjectFacilitySelectionSMCPage> {
...
//               final filteredProjectFacilities = (widget.projectFacilities ?? [])
//                       .isNotEmpty
//                   ? widget.projectFacilities.where((element) {
//                       final query =
//                           form.control(_facilityName).value as String?;
//                       if (query == null || query.isEmpty) return true;
//                       final localizedFacilityIdWithPrefix = widget
...
//     return facilityMap[modelValue?.facilityId] ?? modelValue?.id;
//   }
...
//       (element) =>
//           facilityMap[element.facilityId] == viewValue ||
//           element.id == viewValue,
//     );
//   }
// }
