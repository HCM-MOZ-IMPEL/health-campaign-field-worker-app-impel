...
import '../../../widgets/widgets_smc/custom_digit_text_field.dart';
                      ...
                      onPressed: () async {
                        ...
                        if (shouldSubmit ?? false) {
                          if (context.mounted &&
                              ...
                              widget.referralClientRefId != null) {
                            // router.navigate(SearchReferralsRoute()); #TODO
                          } else {
                            ...
                            child: Text(
                              '${localizations.translate(
                                value.selectedServiceDefinition!.code
                                    .toString(),
                              )} ${localizations.translate(isDistributor ? i18.checklist.communityDistributorChecklist : i18.checklist.checklist)}',
