...
@RoutePage()
class CustomUserDashboardPage extends LocalizedStatefulWidget {
  const CustomUserDashboardPage({
    super.key,
  });

  @override
  State<StatefulWidget> createState() {
    return CustomUserDashboardPageState();
  }
}

class CustomUserDashboardPageState
    extends LocalizedState<CustomUserDashboardPage> {
  @override
  void initState() {
                          ...
                          Align(
                            ...
                            child: InfoCard(
                              title: localizations.translate(
                                  i18_local.dashBoard.dashboardHeaderLabel),
                              description: localizations.translate(
                                  i18_local.dashBoard.noteDescriptionSMC),
                              type: InfoType.info,
                            ),
                          )
                      ],
