...
class CustomBeneficiaryDetailsSMCPage extends LocalizedStatefulWidget {
  ...
  @override
  State<CustomBeneficiaryDetailsSMCPage> createState() =>
      CustomBeneficiaryDetailsSMCPageState();
}

class CustomBeneficiaryDetailsSMCPageState
    extends LocalizedState<CustomBeneficiaryDetailsSMCPage> {
  @override
  void initState() {
